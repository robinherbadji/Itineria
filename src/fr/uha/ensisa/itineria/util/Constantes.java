...
public abstract class Constantes {
	...
	public static final String NOM_ALGO_RECHERCHE[] = { "Parcours en largeur", "Parcours à coût uniforme",
			"Parcours en profondeur", "Parcours en profondeur limitée", "Parcours itératif en profondeur",
			"Recherche gloutonne", "Recherche A*" };
